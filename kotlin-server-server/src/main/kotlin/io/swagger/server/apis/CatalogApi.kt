...
import io.swagger.server.models.Book

fun Route.CatalogApi() {
    val gson = Gson()
    val empty = mutableMapOf<String, Any?>()

    get<Paths.getCatalog> {  it: Paths.getCatalog ->
    ...
    .apply {
      ...
      //       It could be the authentication block is being abused here. Until this is resolved, swallow duplicate exceptions.
        ...
        try {
            ...
            application.environment.log.warn("authentication block for '/catalog' is duplicated in code. " +
    ...
    .apply {
      ...
      //       It could be the authentication block is being abused here. Until this is resolved, swallow duplicate exceptions.
        ...
        try {
            ...
            application.environment.log.warn("authentication block for '/book' is duplicated in code. " +
            "Generated endpoints may need to be merged under a 'route' entry.")
        }
    }
}
